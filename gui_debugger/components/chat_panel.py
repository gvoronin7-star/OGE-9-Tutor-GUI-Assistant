...
class ChatPanel(ttk.Frame):
    ...
    def _create_widgets(self) -> None:
        ...
        self.chat_area.tag_configure("user", foreground="#0078d4", font=("Segoe UI", 10, "bold"))
        ...
        self.chat_area.tag_configure("timestamp", foreground="#606060", font=("Segoe UI", 8))
        ...
        quick_commands = ["/start", "/help", "/progress", "Что такое общество?", "Расскажи про экономику"]
        ...
        # Статус
        self.status_label = ttk.Label(self, text="● Готов к работе", foreground="#107c10")
