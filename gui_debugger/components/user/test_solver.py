...
class TestSolver(ttk.Frame):
    ...
    # Реальные демо-вопросы по каждой теме — третий, самый нижний
    # уровень фолбэка (когда TestGenerator недоступен вообще), поэтому
    # не может опираться на api/test_generator.py (тяжёлый импорт
    # через RAGPipeline, чувствительный к сети) — контент продублирован
    # здесь намеренно, но должен оставаться содержательным, а не
    # структурными заглушками без смысла.
    _DEMO_QUESTIONS_BY_TOPIC: Dict[str, List[Dict[str, Any]]] = {
        "человек и общество": [
            {
                "question": "Что такое общество?",
                "answers": [
                    "Совокупность людей, объединённых общими интересами и связями",
                    "Группа животных",
                    "Компьютерная сеть",
            ...
            },
            {
                ...
                "answers": [
                    ...
                    "Усвоение человеком социальных норм и ценностей",
                    "Общение в интернете",
                    "Работа в коллективе",
                ],
                "correct_answer": 1,
        ...
        "экономика": [
            {
                ...
                "answers": [
                    ...
                    "Производство, распределение и потребление благ",
                    "Историю государства",
                    "Психологию человека",
                ],
                "correct_answer": 1,
            ...
            {
                "question": "Что произойдёт с ценой товара при росте спроса на него?",
                "answers": [
                    "Цена снизится",
                    "Цена возрастёт",
                    "Товар исчезнет",
        ...
        "право": [
            ...
            {
                "question": "Какой документ является основным законом России?",
                "answers": [
                    "Гражданский кодекс",
                    "Уголовный кодекс",
                    "Конституция РФ",
        ...
        "сфера духовной культуры": [
            ...
            {
                "question": "Чем наука отличается от других форм духовной культуры?",
                "answers": [
                    "Стремлением к объективному, проверяемому знанию о мире",
                    "Опорой только на веру",
                    "Отражением мира через художественные образы",
                    "Регулированием поведения через понятия добра и зла",
                ],
                "correct_answer": 0,
            ...
            },
            {
                ...
                "answers": [
                    ...
                    "Мораль регулирует поведение через понятия добра и зла, опираясь на общественное мнение",
    ...
    def _use_demo_test(self, topic: str) -> None:
        """Использование демо-теста по теме (TestGenerator недоступен)."""
        topic_key = topic.lower()
        questions_list: List[Dict[str, Any]] = []

        for key, questions in self._DEMO_QUESTIONS_BY_TOPIC.items():
            if key in topic_key:
                questions_list = questions
                break

        if not questions_list:
            questions_list = self._DEMO_QUESTIONS_BY_TOPIC["человек и общество"]
