...
class RAGPanel(ttk.Frame):
    ...
    def _create_widgets(self) -> None:
        ...
        top_k_spinbox = ttk.Spinbox(
            settings_frame, from_=1, to=20, textvariable=self.top_k_var, width=5
        )
        ...
        source_combo = ttk.Combobox(
            ...
            values=["RAG_data_base", "Local Faiss", "Whoosh"],
            width=15,
            state="readonly",
        )
        ...
        self.rag_status_label = ttk.Label(
            status_frame, text="RAG_data_base: Неактивна", foreground="#e81123"
        )
