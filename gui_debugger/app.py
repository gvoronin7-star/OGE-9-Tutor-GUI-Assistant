...
class OGEDebuggerApp:
    ...
    def __init__(self, rag_pipeline=None, cache_manager=None, test_generator=None, forced_mode=None) -> None:
        """
    ...
    def _create_window(self) -> None:
        ...
        self.status_bar = ttk.Label(
            self.root,
            text="GUI запущен | RAG_data_base: " + ("активна" if self.rag_pipeline and self.rag_pipeline.use_existing else "неактивна"),
            relief=tk.SUNKEN,
            anchor=tk.W
        )
    ...
    def _show_mode(self, mode: str) -> None:
        ...
        if mode == "user":
            ...
            self.status_bar.configure(text="👤 Пользовательский режим | Подготовка к ОГЭ")
        else:
            ...
            self.status_bar.configure(text="⚙️ Административный режим | Отладка и мониторинг")
...
def create_app(rag_pipeline=None, cache_manager=None, test_generator=None, forced_mode=None) -> OGEDebuggerApp:
    """
    Создание приложения.
