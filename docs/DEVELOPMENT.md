...
*Разделы про переменные окружения обновлены 2026-09-08 (зональный аудит хаба); остальной документ - апрель 2026, местами устарел (см. README.md про два клиента и `docs/ARCHITECTURE.md` про актуальное хранилище).*
